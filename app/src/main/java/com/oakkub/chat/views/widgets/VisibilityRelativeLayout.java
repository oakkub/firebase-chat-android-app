...
public class VisibilityRelativeLayout extends RelativeLayout {
    ...
    public VisibilityRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public VisibilityRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public VisibilityRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
